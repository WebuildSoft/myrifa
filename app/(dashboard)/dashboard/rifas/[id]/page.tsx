            ...
            <main className="p-6 space-y-8 max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-8 space-y-8">
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-[10px] font-black text-white/80 uppercase tracking-widest">{paidNumbers}/{rifa.totalNumbers}</span>
                                        </div>
                        ...
                        {/* Winners Section */}
                        <CardWrapper title="Ganhadores da Campanha">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="flex gap-2 pt-2 border-t border-slate-200/50 dark:border-slate-700/50">
                                                    <Button size="sm" variant="outline" className="flex-1 h-8 rounded-xl border-emerald-500/20 text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 gap-2 text-[9px] font-black uppercase tracking-widest" asChild>
                                                        <Link href={`https://wa.me/${prize.winner.whatsapp.replace(/\D/g, '')}?text=Olá ${prize.winner.name}, parabéns! Você ganhou o ${prize.position}º prêmio (${prize.title}) na nossa campanha ${rifa.title}!`} target="_blank">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        <CardWrapper title="Configurações">
                            <div className="space-y-5">
                        ...
                        {/* Raffle Link Section */}
                        <CardWrapper title="Compartilhamento">
                            <div className="space-y-6">
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-primary/10 group overflow-hidden">
                                        ...
                                        <CopyLinkButton url={`https://rifa.com.br/r/${rifa.slug}`} />
                                    </div>
                                </div>
                        ...
                        <div className="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-primary/5 shadow-sm space-y-6 overflow-hidden flex flex-col">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <Link className="text-primary text-[10px] font-black uppercase tracking-widest hover:underline" href={`/dashboard/rifas/${rifa.id}/compradores`}>Ver Tudo</Link>
                            </div>
