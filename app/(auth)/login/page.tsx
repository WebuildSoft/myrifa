        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <form action={loginWithGoogle}>
                    <button type="submit" className="w-full flex items-center justify-center gap-3 h-14 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-800 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-750 transition-all text-slate-700 dark:text-slate-200 font-bold shadow-sm">
